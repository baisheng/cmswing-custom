...
function _type_tr_b () {
  if ($('.type_tr_b1').length > 0) {
    if (localStorage.getItem('cx_type_tr_b') == 1) {
      $('tr.type_tr_m').show();
      $('.type_tr_b1').hide();
      $('.type_tr_b2').show();
    }
    $('.type_tr_b1').click(function () {
      ...
      $(this).hide();
      $('.type_tr_b2').show();
      localStorage.setItem('cx_type_tr_b', 1);
    });
    $('.type_tr_b2').click(function () {
      $('tr.type_tr_m').hide();
      $(this).hide();
      $('.type_tr_b1').show();
      localStorage.removeItem('cx_type_tr_b');
    });
  }
}
...
(function () {
  ...
  b = (function () {
    ...
    function e (a) {
      a == null && (a = {}), this.scrollCallback = f(this.scrollCallback, this), this.scrollHandler = f(this.scrollHandler, this), this.start = f(this.start, this), this.scrolled = !0, this.config = this.util().extend(a, this.defaults), this.animationNameCache = new c()
    }
    ...
    return e.prototype.defaults = {
      ...
      return this.applyStyle(a), a.className = '' + a.className + ' ' + this.config.animateClass, this.config.callback != null ? this.config.callback(a) : void 0
