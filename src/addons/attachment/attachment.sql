...
-- ----------------------------
--  Table structure for `cx_ext_attachment`
-- ----------------------------
DROP TABLE IF EXISTS `cx_ext_attachment`;
CREATE TABLE `cx_ext_attachment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` char(80) NOT NULL,
  `description` varchar(200) DEFAULT NULL,
  `create_time` bigint(13) NOT NULL,
  `type` tinyint(3) NOT NULL DEFAULT '0' COMMENT '0:图片, 1:文件',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '数据状态 0 禁用，1 启用，-1 删除',
...
-- ----------------------------
--  Records of `cx_ext_attachment`
-- ----------------------------
BEGIN;
INSERT INTO `cx_ext_attachment` VALUES ('1', '', 'wangEditor 图片上传接口', '1508682182987', '0', '1', '0', '{\"errno\": 0,\"data\": [\"${url}\"]}', '0', 'wangEditor'), ('2', 'editormd-image-file', 'Editor.md 图片上传返回接口', '1508687544227', '0', '1', '0', '{ \"success\": 1,\"message\": \"上传成功\",\"url\": \"${url}\"}', '0', 'editormd'), ('3', '', 'wangEditor  手机端图片上传返回接口', '1508688874449', '0', '1', '0', '${url}', '0', 'mwangEditor');
COMMIT;

-- ----------------------------
--  Table structure for `cx_ext_attachment_file`
-- ----------------------------
DROP TABLE IF EXISTS `cx_ext_attachment_file`;
CREATE TABLE `cx_ext_attachment_file` (
...
-- ----------------------------
--  Table structure for `cx_ext_attachment_pic`
-- ----------------------------
DROP TABLE IF EXISTS `cx_ext_attachment_pic`;
CREATE TABLE `cx_ext_attachment_pic` (
