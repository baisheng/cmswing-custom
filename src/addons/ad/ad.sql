...
-- ----------------------------
-- Table structure for cx_ext_ad
-- ----------------------------
DROP TABLE IF EXISTS `cx_ext_ad`;
CREATE TABLE `cx_ext_ad` (
...
-- ----------------------------
-- Records of cx_ext_ad
-- ----------------------------
INSERT INTO `cx_ext_ad` VALUES ('24', '代码1', '15', 'code', '[{\"code\":\"<div class=\\\"box-flip box-icon box-icon-center box-icon-round box-icon-large text-center\\\">\\r\\n\\t\\t\\t<div class=\\\"front\\\">\\r\\n\\t\\t\\t\\t<div class=\\\"box1\\\">\\r\\n\\t\\t\\t\\t\\t<div class=\\\"box-icon-title\\\">\\r\\n\\t\\t\\t\\t\\t\\t<i class=\\\"fa fa-check\\\"></i>\\r\\n\\t\\t\\t\\t\\t\\t<h2>Full Width</h2>\\r\\n\\t\\t\\t\\t\\t</div>\\r\\n\\t\\t\\t\\t\\t<p>Nullam id dolor id nibh ultricies vehicula ut id elit. Integer posuere erat a ante venenatis dapibus posuere</p>\\r\\n\\t\\t\\t\\t</div>\\r\\n\\t\\t\\t</div>\\r\\n\\r\\n\\t\\t\\t<div class=\\\"back\\\">\\r\\n\\t\\t\\t\\t<div class=\\\"box2\\\">\\r\\n\\t\\t\\t\\t\\t<h4>BACK SIDE</h4>\\r\\n\\t\\t\\t\\t\\t<hr />\\r\\n\\t\\t\\t\\t\\t<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas metus nulla, commodo a sodales sed, dignissim pretium nunc. Nam et lacus neque. Ut enim massa, sodales tempor convallis et, iaculis ac massa. Maecenas metus nulla, commodo a sodales sed, dignissim pretium nunc. Nam et lacus neque.</p>\\r\\n\\t\\t\\t\\t</div>\\r\\n\\t\\t\\t</div>\\r\\n\\t\\t</div>\"}]', '1489167480000', '1490895480000', '1489167627733', '0', '0', '0', '1');
INSERT INTO `cx_ext_ad` VALUES ('21', '文字广告三', '14', 'text', '[{\"alt\":\"支持自定义用户行为\",\"info\":\"为您的运营决策提供有效参考数据\",\"ico\":\"fa-group\"}]', '1489113480000', '1490927880000', '1489113600600', '0', '0', '3', '1');
INSERT INTO `cx_ext_ad` VALUES ('19', '文字广告一', '14', 'text', '[{\"alt\":\"全新的架构和模块化开发机制\",\"info\":\"便于灵活扩展和二次开发\",\"ico\":\"fa-cubes\"}]', '1489108320000', '1490922720000', '1489108510299', '0', '0', '1', '1');
INSERT INTO `cx_ext_ad` VALUES ('20', '文字广告二', '14', 'text', '[{\"alt\":\"模型/栏目/分类信息体系\",\"info\":\"轻松实现差异化的功能\",\"ico\":\"fa-tasks\"}]', '1489109400000', '1490923800000', '1489109589707', '0', '0', '2', '1');
INSERT INTO `cx_ext_ad` VALUES ('17', '轮播广告第一个', '13', 'images', '[{\"url\":\"http://www.sina.com\",\"alt\":\"轮播第一个\",\"att\":\"818\"}]', '1489052460000', '1490953260000', '1489052709516', '0', '0', '0', '1');
INSERT INTO `cx_ext_ad` VALUES ('18', '轮播广告第二个', '13', 'images', '[{\"url\":\"http://www.baidu.com\",\"alt\":\"第二个\",\"att\":\"819\"}]', '1489052760000', '1490953560000', '1489052916332', '0', '0', '0', '1');
INSERT INTO `cx_ext_ad` VALUES ('22', '文字广告四', '14', 'text', '[{\"alt\":\"云存储、云安全等服务\",\"info\":\"更多贴心的服务让您的网站更安心\",\"ico\":\"fa-soundcloud\"}]', '1489113780000', '1490928180000', '1489113849154', '0', '0', '4', '1');
INSERT INTO `cx_ext_ad` VALUES ('16', 'cx图片广告', '11', 'images', '[{\"url\":\"http://www.cx.com\",\"alt\":\"fdsafdsafdsaf\",\"att\":\"817\"}]', '1488935640000', '1490836440000', '1488937997050', '0', '0', '0', '1');
INSERT INTO `cx_ext_ad` VALUES ('25', '测试广告', '16', 'images', '[{\"url\":\"http://www.baidu.com\",\"alt\":\"fdsfdsa\"}]', '1493281686040', '1495873686040', '1493281686040', '0', '0', '0', '1');

-- ----------------------------
-- Table structure for cx_ext_ad_space
-- ----------------------------
DROP TABLE IF EXISTS `cx_ext_ad_space`;
CREATE TABLE `cx_ext_ad_space` (
...
-- ----------------------------
-- Records of cx_ext_ad_temp
-- ----------------------------
INSERT INTO `cx_ext_ad_temp` VALUES ('1', 'banner', '矩形横幅', '0', '0', '0', '1', '0', '1', '1', '{\"images\":\"1\",\"flash\":0,\"text\":0,\"code\":0}', '<a class=\"margin-bottom-20 block thumbnail\" href=\"[url]\" target = \"_blank\" title = \"[alt]\" >\r\n<img class=\"img-responsive\" src=\"[att|get_pic]\" alt=\"[alt]\" style=\"height:[height]px;width:100%\">\r\n</a>');
INSERT INTO `cx_ext_ad_temp` VALUES ('2', 'imagechange', '图片轮换广告', '0', '0', '0', '1', '1', '1', '1', '{\"images\":\"1\",\"flash\":0,\"text\":0,\"code\":0}', '<!-- BANNER ROTATOR -->\r\n<div class=\"owl-carousel buttons-autohide controlls-over margin-bottom-20 text-center\" data-plugin-options=\'{\"singleItem\": true, \"autoPlay\": 4000, \"navigation\": true, \"pagination\": true, \"transitionStyle\":\"goDown\"}\'>\r\n{loop}\r\n<a href=\"[url]\">\r\n<img class=\"img-responsive\" src=\"[att|get_pic]\" width=\"[width]\" height=\"[height]\" alt=\"[alt]\">\r\n</a>\r\n{/loop}\r\n</div>\r\n<!-- /BANNER ROTATOR -->');
INSERT INTO `cx_ext_ad_temp` VALUES ('3', 'code', '代码广告', '0', '0', '0', '0', '0', '1', '1', '{\"code\":\"1\",\"images\":0,\"flash\":0,\"text\":0}', '[code]');
INSERT INTO `cx_ext_ad_temp` VALUES ('4', 'text', '文字广告', '0', '0', '0', '0', '1', '1', '1', '{\"text\":\"1\",\"images\":0,\"flash\":0,\"code\":0}', '<div class=\"info-bar info-bar-clean info-bar-bordered nomargin\">\r\n		<div class=\"container\">\r\n			<div class=\"row\">\r\n{loop}\r\n				<div class=\"col-sm-3\">\r\n					<i class=\"fa [ico]\"></i>\r\n					<h3><a herf=\"[url]\">[alt]</a></h3>\r\n					<p>[info]</p>\r\n				</div>\r\n{/loop}\r\n			</div>\r\n		</div>\r\n	</div>');
