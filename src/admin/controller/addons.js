...
module.exports = class extends Base {
  ...
  table: [], // 插件包含的 数据库表，不包含表前缀，如：picker_ext_table 就是 table，多个['table','table_2']没有留空数组。
...
module.exports = class extends think.picker.extIndex {
  ${hookhtml}
}`;
   ...
   */
  async sortAction () {
    await super.sortAction('ext', 'ext');
  }
