...
module.exports = {
  ...
  common: {
    ...
    ModuleIndex: require(path.join(rootPath, 'src', 'common', 'controller', 'modIndexBase')),
    ModuleAdmin: require(path.join(rootPath, 'src', 'common', 'controller', 'modAdminBase')),
    extIndex: require(path.join(rootPath, 'src', 'common', 'controller', 'extIndexBase')),
    AddonIndex: require(path.join(rootPath, 'src', 'common', 'controller', 'extIndexBase')),
    extAdmin: require(path.join(rootPath, 'src', 'common', 'controller', 'extAdminBase')),
    AddonAdmin: require(path.join(rootPath, 'src', 'common', 'controller', 'extAdminBase')),
